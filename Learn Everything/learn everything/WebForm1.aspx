<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="learn_everything.WebForm1" %>
        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                  ...
                  <a href="#" class="navbar-brand scroll-top">                </div></font>              <font color="black" ><h1>    Learn Everything                 </h1></a>
                <!--/.navbar-header-->
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="#" class="scroll-top"><font color="black" >Home</font></a></li>
                        <li><a href="#" class="scroll-link" data-id="about"><font color="black" >About Us</font></a></li>
                        <li><a href="#" class="scroll-link" data-id="portfolio"><font color="black" >Start Learning</font></a></li>
                        <li><a href="#" class="scroll-link" data-id="blog"><font color="black" >Inspirations</font></a></li>
                        <li><a href="#" class="scroll-link" data-id="contact"><font color="black" >Contact Us</font></a></li>
                    </ul>
                </div>
                <!--/.navbar-collapse-->
            </nav>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item first-service">
                        <div class="icon"></div>
                        <h4>Easy Learning</h4>
                        <p>In this generation every skill is important and to help peole to learn it under a common place we provide our space.</p>
                    </div>
                </div>
                 <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item second-service">
                        <div class="icon"></div>
                        <h4>Increce Your Creativity </h4>
                        <p>Our course are not any genre specific.We provide a collection of open to every creativity full packaged course.</p>
                    </div>
                </div>
                 <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item third-service">
                        <div class="icon"></div>
                        <h4>At No Cost</h4>
                        <p>There is no price on learning,it's your passion which counts .So start learning withot any restrictions.</p>
                    </div>
                </div>
                 <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item fourth-service">
                        ...
                        <p>Our reach is not audiece specific,we are providing the best learning experience to anyone and everyone.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="fact-item">
                            ...
                            <span>Total Subscribed Teachers</span>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="fact-item">
    ...
    <div id="what-we-do">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="left-text">
                        <h4>EASE YOUR EXPERIENCE,<br>Subscribe now and take profit.</h4>
                        <p>We have launched for yuor convinience the facility that you can subscribe to us and get notification regarding every new course .</p>
                        <ul>
                            <li>
        ...
        <div class="content-wrapper">
            <div class="inner-container container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
                            <h4>WHAT ARE YOU LEARNING TODAY ?</h4>
                          <div class="line-dec"></div>
                ...
                <div class="projects-holder-3">
                    <div class="filter-categories">
                        <ul class="project-filter">
                            ...
                            <li class="filter" data-filter="nature"><span>ACDEMICS</span></li>
                            <li class="filter" data-filter="workspace"><span>SPORTS</span></li>
                            <li class="filter" data-filter="city"><span>ARTISTIC</span></li>
                            <li class="filter" data-filter="technology"><span>FOOD</span></li>
                        </ul>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 project-item mix nature">
                              <div class="thumb">
                                  ...
                                  <div class="hover-effect">
                                    <a href="gs.html"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix workspace">
                              <div class="thumb">
                                  ...
                                  <div class="hover-effect">
                                    <a href="gsp.html"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix city">
                              <div class="thumb">
                                  ...
                                  <div class="hover-effect">
                                    <a href="gd.html"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix city">
                              <div class="thumb">
                                  ...
                                  <div class="hover-effect">
                                    <a href="gm.html"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix city">
                              <div class="thumb">
                                  ...
                                  <div class="hover-effect">
                                    <a href="gp.html"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix technology">
                              <div class="thumb">
                                  ...
                                  <div class="hover-effect">
                                    <a href="gco.html"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix city">
                              <div class="thumb">
                                  ...
                                  <div class="hover-effect">
                                    <a href="gc.html"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix nature">
                              <div class="thumb">
                                  ...
                                  <div class="hover-effect">
                                    <a href="gcd.html"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="blog-item second-blog b2">
                        <div class="thumb">
                            <img src="img1/blog_02.jpg" alt="">
                            <div class="text-content">

                                <span>“Teaching in the Internet age means we must teach tomorrow’s skills today.” </span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="blog-item b3">
                        <div class="thumb">
                            <img src="img/blog_03.jpg" >
                            <div class="text-content">
                                <h4>Steven Spielberg</h4>
                                <span>This famous Director of various movies followed his passion and learned dispite of enorilling in any institution.</span>
                            </div>
                        </div>
                    </div>
                </div>
...
Spielberg is one of the American film industry's most critically successful filmmakers, with praise for his directing talent and versatility,and he has won the Academy Award for Best Director twice. Some of his movies are also among the highest-grossing movies of all-time, while his total work makes him the highest-grossing film director in history. His net worth is estimated to be more than $3 billion.
    ...
    function run() {
        let phrases = [
            ...
            "HOW TO DO CONTEMPORARY DANCING",
            "COOKING CHINEESE CUISINE",
            "PLAYING PIANO",
            "HOW TO DO FUNCTIONAL CRAFTING",
            "HOW TO PLAY TENNIS",
            "HOW TO DO CODING IN JAVA",
            "HOW TO DO DANCING",
            "HOW TO DO COOKING",
            "INTEGRATION IN MATHS",
            "HOW TO DO OIL PAINTING",
            ...
            "HOW TO DO FUNCTIONAL CRAFTING",
            "HOW TO PLAY TENNIS",
            "HOW TO DO CODING IN JAVA","HOW TO DO CONTEMPORARY DANCING",
            "COOKING CHINEESE CUISINE",
            "PLAYING PIANO",
            "HOW TO DO FUNCTIONAL CRAFTING",
            "HOW TO PLAY TENNIS",
            "HOW TO SPEAK ENGLISH WITH RIGHT VOCABULARY"
